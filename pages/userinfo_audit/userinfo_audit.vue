...
<!-- 			<uni-group title="注意事项">
				<view style="flex-direction: column;">
					<text style='color:red;'>1.请仔细阅读《知情同意书》和《隐私协议》\n</text>
					<text style='color:red;'>2.姓名，身份，出生年月，性别，年龄，家庭结构，电话，邮箱和紧急联系人信息仅用于帮助心理咨询，不做其他用途</text>
				</view>
			</uni-group> -->
...
<!-- 			<uni-group title="紧急联系人" top="20">
				...
				<u-checkbox-group v-if="promiseShow" @change="checkboxGroupChange">
					...
					<text @click='gotoPromise' style='color:red;'>《知情同意书》</text>
					<text>及</text>
...
<script>
	...
	export default {
		...
		onLoad() {
			// wx.showModal({
			// 	title: '用户隐私确认',
			// 	content: '请确认同意填写您本人的个人信息，我们保证所有用户信息都会被保密且仅用于心理咨询分析，不用于其他途径，如您不同意请点击否',
